            ...
            setTimeout(function () {
                ...
                cont.append(portfolioContainer);
                    ...
                    setTimeout(function () {
                        ...
                        portfolioPictureContainer.classList.add ("portfolio-picture-container");
                        portfolioContainer.append(portfolioPictureContainer)
                        let portfolioPicture = document.createElement("img")
                        portfolioPicture.src = "https://forum.neverlose.cc/user_avatar/forum.neverlose.cc/azverexd/120/248465_2.png"
                        ...
                        portfolioPicture.addEventListener("mouseleave", function () {
                            pict_hover = false

                        }, false);
                        portfolioPicture.addEventListener("mouseover", function () {
                            pict_hover = true
                        ...
                        portfolioPicture.addEventListener('click',function () {
                            ...
                            if (blur) {
                                ...
                                s.classList.add("portfolio-text")
                                g.classList.add("portfolio-text")
                                d.classList.add("portfolio-text")
                                t.classList.add("portfolio-text")
                        ...
                        setTimeout(function () {
                            ...
                            portfolioTitleAnim.setText("AzverexD");
